...
const ScoreDisplay: React.FC<ScoreDisplayProps> = ({ score, gold, onShopOpen }) => {
  return (
    <div className="flex gap-3">
      <div className="flex items-center gap-2 bg-black/90 p-2 px-3 rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.9)] border border-slate-700/50">
      ...
      <div 
        className="flex items-center gap-2 bg-black/90 p-2 px-3 rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.9)] border border-slate-700/50 cursor-pointer hover:bg-slate-900/90 transition-colors"
        onClick={onShopOpen}
      >
